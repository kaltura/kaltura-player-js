...
export default class IntersectionObserverPolyfill {
  ...
  static install(): void {
    ...
    if ('IntersectionObserver' in window &&
      ...
      IntersectionObserverPolyfill._logger.debug('No need to install polyfill');

      return;
    }

    IntersectionObserverPolyfill._logger.debug('Installing polyfill');
...
PolyfillManager.register(IntersectionObserverPolyfill);
