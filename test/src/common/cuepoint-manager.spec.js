...
import {CuePointManager} from '../../../src/common/cuepoint-manager';
...
describe('CuePointManager', () => {
  ...
  it('should add/get/remove cue points', function () {
    const cuePoints = [
      {
        id: 'test-id-1',
        startTime: 1,
    ...
    expect(player.cuePointManager.getAllCuePoints().length).eql(1);
  });
});
