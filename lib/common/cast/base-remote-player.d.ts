...
import { EventManager, FakeEventTarget, TextStyle, Track } from '@playkit-js/playkit-js';
...
declare class BaseRemotePlayer extends FakeEventTarget implements IRemotePlayer {
   ...
   * @memberof BaseRemotePlayer
   */
  loadMedia(mediaInfo: Object): Promise<any>;
  /**
...
//# sourceMappingURL=base-remote-player.d.ts.map
