 ...
 * @returns {void}
 */
declare function getRedirectExternalStreamsHandler(playerOptions: KalturaPlayerConfig, mediaOptions?: KalturaPlayerConfig | {}): Object;
export { getRedirectExternalStreamsHandler };
//# sourceMappingURL=external-stream-redirect-helper.d.ts.map
